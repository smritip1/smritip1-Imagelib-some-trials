...
/**
 * This example uses a global threshold for segmenting an image
 * Opens a file with ImgOpener and threshold it based on a pre-defined value
 * All the pixels in the input image which are less than or equal to 140 are set to 0 (black) and
 * the pixels above 140 are set to 255 (white)
 * 
 * */
public class TryEx {
